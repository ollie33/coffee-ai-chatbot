        ...
        <div className="fixed bottom-24 right-6 w-[380px] h-[600px] bg-white rounded-2xl shadow-2xl border border-neutral-100 flex flex-col z-50 overflow-hidden animate-in slide-in-from-bottom-4 fade-in duration-200">
          ...
          <div className="bg-black text-white px-4 py-3.5 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="font-semibold text-sm leading-tight">智能咖啡顧問</p>
            ...
            {!handedOff && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs bg-white/15 hover:bg-white/25 px-3 py-1.5 rounded-full transition-colors"
              >
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-neutral-50/50">
            ...
            {loading && (
              <div className="flex items-end gap-2 justify-start">
                ...
                <div className="bg-white border border-neutral-200 rounded-2xl rounded-bl-sm px-3.5 py-3 shadow-sm flex gap-1 items-center">
            ...
            {handedOff && (
              <div className="flex flex-col items-center gap-2 py-2">
                <div className="bg-amber-50 text-amber-800 border border-amber-200 text-xs px-4 py-2 rounded-full flex items-center gap-2">
                ...
                <button
                  ...
                  className="text-xs px-3 py-1 bg-neutral-100 hover:bg-neutral-200 text-neutral-600 rounded-lg transition-colors"
                >
                  取消等待
                </button>
              </div>
            ...
            {handedOff ? (
              ...
              >
                <input
                  ...
                  placeholder="輸入訊息..."
                  maxLength={500}
                  className="w-full bg-neutral-100 rounded-full pl-4 pr-12 py-3 text-sm text-neutral-900 focus:outline-none focus:ring-2 focus:ring-black/10 transition-all"
                />
                <button
                  type="submit"
